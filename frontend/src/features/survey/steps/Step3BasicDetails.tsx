      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="other">{t('step3.educationOther')}</SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        {data.educationLevel === 'other' && (
          <div className="space-y-2 ml-4">
            <Label htmlFor="otherEducation">{t('step3.otherEducationLabel')}</Label>
            <Input
              id="otherEducation"
              value={data.otherEducation}
              onChange={(e) => updateData({ otherEducation: e.target.value })}
              placeholder={t('step3.otherEducationPlaceholder')}
            />
          </div>
        )}
        ...
        <div className="space-y-2">
          ...
          <MultiSelect
            options={languageOptions.map((lang) => ({ value: lang.value, label: lang.value }))}
