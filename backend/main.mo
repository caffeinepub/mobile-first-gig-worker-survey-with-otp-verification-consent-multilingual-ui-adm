...
actor {
  ...
  public type Survey = {
    ...
    monthlyIncome : Text;
    hourlyRate : Text;
    keepsMoneyInAccount : Bool;
    lifeInsurance : ?Bool;
    healthInsurance : ?Bool;
    accidentalInsurance : ?Bool;
    phoneType : Text;
    usesSmartphone : Bool;
    ownsLaptop : Bool;
    otherDevice : Text;
    ableToDoVideoCall : Bool;
    usesMobileData : Bool;
    internetConnection : Text;
    remainingBalance : Text;
    postpaidAccount : Text;
    averageDailyUsage : Text;
    usesBankApps : Bool;
    usesPaymentApps : Bool;
    hasTradingAccount : Bool;
    hasBusinessAccounts : Bool;
    followsRegulations : Bool;
    paidDuringCovid : Bool;
    speaksEnglish : Bool;
    passport : Bool;
    overseasWork : Bool;
    incomeTaxPayer : Bool;
    ...
    pfEsi : ?Text;
    voterIdImage : ?Storage.ExternalBlob;
    servingState : ?Text;
    iosSmartphone : ?Bool;
    rechargeType : ?Text;
    rechargeAmount : ?Text;
    ...
    mostlyUsedApps : ?Text;
    ableToMail : ?Bool;
    ableToPayThroughApp : ?Bool;
    overtimeMoney : ?Text;
    primaryWorkLocation : Text;
    workingDaysLowReason : Text;
    employerGivesAccommodation : Text;
  };
  ...
  public shared ({ caller }) func submitSurvey(survey : Survey) : async () {
    ...
    let persistedSurvey : Survey = {
      ...
      otherEducation = survey.otherEducation;
      monthlyIncome = survey.monthlyIncome;
      hourlyRate = survey.hourlyRate;
      keepsMoneyInAccount = survey.keepsMoneyInAccount;
      lifeInsurance = survey.lifeInsurance;
      healthInsurance = survey.healthInsurance;
      accidentalInsurance = survey.accidentalInsurance;
      phoneType = survey.phoneType;
      usesSmartphone = survey.usesSmartphone;
      ownsLaptop = survey.ownsLaptop;
      otherDevice = survey.otherDevice;
      ableToDoVideoCall = survey.ableToDoVideoCall;
      usesMobileData = survey.usesMobileData;
      internetConnection = survey.internetConnection;
      remainingBalance = survey.remainingBalance;
      postpaidAccount = survey.postpaidAccount;
      averageDailyUsage = survey.averageDailyUsage;
      usesBankApps = survey.usesBankApps;
      usesPaymentApps = survey.usesPaymentApps;
      hasTradingAccount = survey.hasTradingAccount;
      hasBusinessAccounts = survey.hasBusinessAccounts;
      followsRegulations = survey.followsRegulations;
      paidDuringCovid = survey.paidDuringCovid;
      speaksEnglish = survey.speaksEnglish;
      passport = survey.passport;
      overseasWork = survey.overseasWork;
      incomeTaxPayer = survey.incomeTaxPayer;
      insuranceDetails = survey.insuranceDetails;
      pfEsi = survey.pfEsi;
      voterIdImage = survey.voterIdImage;
      servingState = survey.servingState;
      iosSmartphone = survey.iosSmartphone;
      rechargeType = survey.rechargeType;
      rechargeAmount = survey.rechargeAmount;
      ableToUseApp = survey.ableToUseApp;
      mostlyUsedApps = survey.mostlyUsedApps;
      ableToMail = survey.ableToMail;
      ableToPayThroughApp = survey.ableToPayThroughApp;
      overtimeMoney = survey.overtimeMoney;
      primaryWorkLocation = survey.primaryWorkLocation;
      workingDaysLowReason = survey.workingDaysLowReason;
      employerGivesAccommodation = survey.employerGivesAccommodation;
    };
